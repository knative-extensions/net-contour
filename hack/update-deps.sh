...
CONTOUR_VERSION="v1.19.1" # This is for controlling which version of contour we want to use.
CONTOUR_OPERATOR_VERSION="v1.19.1" # This is for controlling which version of contour-operator we want to use.
