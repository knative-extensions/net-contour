...
import (
	...
	internalinterfaces "knative.dev/net-contour/pkg/client/informers/externalversions/internalinterfaces"
	v1 "knative.dev/net-contour/pkg/client/listers/projectcontour/v1"
)
...
func (f *tLSCertificateDelegationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&projectcontourv1.TLSCertificateDelegation{}, f.defaultInformer)
}
