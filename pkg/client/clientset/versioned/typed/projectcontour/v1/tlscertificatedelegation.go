...
type TLSCertificateDelegationInterface interface {
	...
	UpdateStatus(ctx context.Context, tLSCertificateDelegation *v1.TLSCertificateDelegation, opts metav1.UpdateOptions) (*v1.TLSCertificateDelegation, error)
...
func newTLSCertificateDelegations(c *ProjectcontourV1Client, namespace string) *tLSCertificateDelegations {
...
func (c *tLSCertificateDelegations) List(ctx context.Context, opts metav1.ListOptions) (result *v1.TLSCertificateDelegationList, err error) {
	...
	result = &v1.TLSCertificateDelegationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tlscertificatedelegations").
...
func (c *tLSCertificateDelegations) UpdateStatus(ctx context.Context, tLSCertificateDelegation *v1.TLSCertificateDelegation, opts metav1.UpdateOptions) (result *v1.TLSCertificateDelegation, err error) {
	result = &v1.TLSCertificateDelegation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tlscertificatedelegations").
